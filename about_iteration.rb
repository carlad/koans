...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It combines all of the items in the array by applying a function 
    # (specified here as sum) and applying another operation
  ...
  #   # code to read 'file'
  #
  #   Because we wanted to iterate through the contents of the file and
